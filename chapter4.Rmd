...
```
We can see from the crosstabulation that we have 28 wrongly predicted classes out of a 102. In percentages we would have a success rate of about 72% with out model, which isn't too bad with such a small dataset, but still could be better. 
